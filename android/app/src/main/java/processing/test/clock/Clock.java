...
boolean f = true, prev = true, resized = false;
boolean[][][] digitsmask = {
  {{true, true, true, true}, {true, true, true, true}, {true, true, true, true}, {true, true, true, true}, {true, true, true, true}, {true, true, true, true}, {true, true, true, true}}, 
  {{false, false, true, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}}, 
  {{true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {true, true, true, true}, {true, false, false, false}, {true, false, false, false}, {true, true, true, true}}, 
  {{true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {true, true, true, true}}, 
  {{true, false, false, true}, {true, false, false, true}, {true, false, false, true}, {true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}}, 
  {{true, true, true, true}, {true, false, false, false}, {true, false, false, false}, {true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {true, true, true, true}}, 
  {{true, true, true, true}, {true, false, false, false}, {true, false, false, false}, {true, true, true, true}, {true, false, false, true}, {true, false, false, true}, {true, true, true, true}}, 
  {{true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {false, false, true, true}, {false, false, false, true}, {false, false, false, true}, {false, false, false, true}}, 
  {{true, true, true, true}, {true, false, false, true}, {true, false, false, true}, {true, true, true, true}, {true, false, false, true}, {true, false, false, true}, {true, true, true, true}}, 
  {{true, true, true, true}, {true, false, false, true}, {true, false, false, true}, {true, true, true, true}, {false, false, false, true}, {false, false, false, true}, {true, true, true, true}}
};
int cx, cy, year, mon, day, hr, min, sec, ms, lastT, deltaT, mc, i, cas = 0;
int radius, acc = 1, g = 0, ph, pw, cells = 20, rand = 100, rbri = 70, sat = 255;
int[] pos;
...
public void draw() {
  //if (frame.getWidth()!=pw) {
  //  frame.setSize(max(width, 128), max(height, 128));
  //  update();
  //}
  frameRate(cas==5?60:25565);
  ...
  float st = sec + ms / 1000.0f, 
    ...
    ht = hr + norm(mt, 0, 60), 
    dt = day + norm(ht, 0, 24), 
    mot = mon + norm(dt, 0, maxd+1), 
    yt = year + norm(mot, 0, 13);
  ...
  case 1:
    ...
    arc(0, 0, mode2r*48.5f/60, mode2r*48.5f/60, -HALF_PI, map(dt, 0, (maxd+1), 0, PI*2) - HALF_PI);

    stroke(mot*360/13.f, 255, bri/2+127);
    strokeWeight(mode2r/20);
    arc(0, 0, mode2r*43/60, mode2r*43/60, -HALF_PI, map(mot, 0, 13, 0, PI*2) - HALF_PI);
  ...
  stroke(127);
  fill(127);
  for (int n=0; n<buttons.length; n++) buttons[n].display();
...
public void gen(/*int ye, int mo, int da, int ho, int mi, int se, */int bri) {
  bri= PApplet.parseInt(255-(255-bri)/1.7f);
  int cell = height/cells, w = ceil(width/(cell*1.f)), h = cells;
  //boolean[][] mask = new boolean[h][w];
  //for (boolean[] a : mask)for (boolean b : a) b = false;
  //mask = mask &&
  background(255);
  for (int y = 0; y < h; y++) {
    for (int x = 0; x < w; x++) {
      noStroke();
      float brig = 255-pow(max(0, noise(frameCount/40.0f+x*10000+y*10) / 1.5f), 2)*rbri;
      fill((y * 360.0f / h + noise(frameCount/1000.0f+x*10000+y*10+7000) * rand / 2 + 360)%360, 
        max( 
        255 - pow(.3f+noise(frameCount/300.0f+x*10000+y*10+123213) / 2, 2) * sat, 
      ...
      endShape(CLOSE);
      brig = 255-pow(.5f+noise(frameCount/40.0f+x*10000+y*10-1000) / 2, 2)*rbri;
      fill((y * 360.0f / h + noise(frameCount/1000.0f+x*10000+y*10+75476) * rand / 2 + 360)%360, 
        max( 
        255 - pow(.3f+noise(frameCount/300.0f+x*10000+y*10+5432) / 2, 2) * sat, 
        255 - pow(brig/255, 4) * 255
        ), 
        brig/255*bri
        );
...
public void mouseReleased() {
  setSize(max(width, 128), max(height, 128));
  update();
}
class Button  
{    
