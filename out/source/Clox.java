...
int radius, g = 0, ph, pw, cells = 20, rand = 144, rbri = 70, sat = 255, ps, calls, lastKeyCode;
int[] pos;
...
public void draw() {
  ...
  case 0:
    ...
    push();
    {
      ...
      float s = map(drawSecondsHand?(sec+ms/1000.0f):0, 0, 30, 0, -PI);
  ...
  if (clockIndex>-1) {
    ...
    String debug = "" + 
      ...
      (usedDebugOverlays[2]?(yt + " " + mot + " " + dt + " " + ht + " " + mt + " " + st + " " + mod+'\n'):"")+
...
public void odigit(float x, float y, float z, float w, int digit) {
  ...
  if (3 - z * w * 2.5f > - (y + w * 7)) 
  {
    ...
    beginShape(QUADS);
    if (digit>-1&&digit<10) {
      oquad(x+w*3, y+w*0, z, w, w);
      oquad(x+w*(3-PApplet.parseInt(digit==7)), y+w*6, z, w, w);
    }
    switch(digit) {
    case 0:
      oquad(x, y+w*1, z, w, w);
      ...
      oquad(x, y+w*4, z, w, w);
      oquad(x, y+w*5, z, w, w);
      oquad(x+w*1, y+w*6, z, w, w);
      oquad(x+w*2, y+w*6, z, w, w);
      oquad(x+w*4, y+w*1, z, w, w);
      oquad(x+w*4, y+w*2, z, w, w);
      oquad(x+w*4, y+w*3, z, w, w);
      oquad(x+w*4, y+w*4, z, w, w);
      oquad(x+w*4, y+w*5, z, w, w);
      oquad(x+w*1, y, z, w, w);
      oquad(x+w*2, y, z, w, w);//14
      break;
    case 1:
      oquad(x+w*2, y+w*1, z, w, w);
      oquad(x+w*3, y+w*1, z, w, w);
      oquad(x+w*3, y+w*2, z, w, w);
      oquad(x+w*3, y+w*3, z, w, w);
      oquad(x+w*3, y+w*4, z, w, w);
      oquad(x+w*3, y+w*5, z, w, w);//6
      break;
    case 2:
      oquad(x+w*0, y+w*1, z, w, w);
      oquad(x+w*0, y+w*6, z, w, w);
      oquad(x+w*1, y+w*0, z, w, w);
      oquad(x+w*1, y+w*5, z, w, w);
      oquad(x+w*1, y+w*6, z, w, w);
      oquad(x+w*2, y+w*0, z, w, w);
      oquad(x+w*2, y+w*4, z, w, w);
      oquad(x+w*2, y+w*6, z, w, w);
      oquad(x+w*3, y+w*3, z, w, w);
      oquad(x+w*4, y+w*1, z, w, w);
      oquad(x+w*4, y+w*2, z, w, w);
      oquad(x+w*4, y+w*6, z, w, w);//12
      break;
    case 3:
      oquad(x, y+w*1, z, w, w);
      oquad(x+w*2, y+w*3, z, w, w);
      oquad(x, y+w*5, z, w, w);
      oquad(x+w*1, y+w*6, z, w, w);
      oquad(x+w*2, y+w*6, z, w, w);
      oquad(x+w*4, y+w*1, z, w, w);
      ...
      oquad(x+w*4, y+w*5, z, w, w);
      oquad(x+w*1, y, z, w, w);
      oquad(x+w*2, y, z, w, w);//12
      break;
    case 4:
      oquad(x+w*0, y+w*3, z, w, w);
      oquad(x+w*0, y+w*4, z, w, w);
      oquad(x+w*1, y+w*2, z, w, w);
      oquad(x+w*1, y+w*4, z, w, w);
      oquad(x+w*2, y+w*1, z, w, w);
      oquad(x+w*2, y+w*4, z, w, w);
      oquad(x+w*3, y+w*1, z, w, w);
      oquad(x+w*3, y+w*2, z, w, w);
      oquad(x+w*3, y+w*3, z, w, w);
      oquad(x+w*3, y+w*4, z, w, w);
      oquad(x+w*3, y+w*5, z, w, w);
      oquad(x+w*4, y+w*4, z, w, w);//12
      break;
    case 5:
      oquad(x+w*0, y+w*0, z, w, w);
      oquad(x+w*0, y+w*1, z, w, w);
      oquad(x+w*0, y+w*2, z, w, w);
      oquad(x+w*0, y+w*5, z, w, w);
      oquad(x+w*1, y+w*0, z, w, w);
      oquad(x+w*1, y+w*2, z, w, w);
      oquad(x+w*1, y+w*6, z, w, w);
      oquad(x+w*2, y+w*0, z, w, w);
      oquad(x+w*2, y+w*2, z, w, w);
      oquad(x+w*2, y+w*6, z, w, w);
      oquad(x+w*3, y+w*2, z, w, w);
      oquad(x+w*4, y+w*0, z, w, w);
      oquad(x+w*4, y+w*3, z, w, w);
      oquad(x+w*4, y+w*4, z, w, w);
      oquad(x+w*4, y+w*5, z, w, w);//15
      break;
    case 6:
      oquad(x+w*0, y+w*1, z, w, w);
      oquad(x+w*0, y+w*2, z, w, w);
    ...
    case 7:
      ...
      oquad(x+w*2, y+w*0, z, w, w);
      oquad(x+w*2, y+w*4, z, w, w);
      oquad(x+w*2, y+w*5, z, w, w);
      oquad(x+w*3, y+w*3, z, w, w);
      oquad(x+w*4, y+w*0, z, w, w);
      oquad(x+w*4, y+w*1, z, w, w);
      oquad(x+w*4, y+w*2, z, w, w);//9
      break;
    case 8:
      oquad(x+w*0, y+w*1, z, w, w);
      oquad(x+w*0, y+w*2, z, w, w);
